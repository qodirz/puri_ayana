...
class _HutangPageState extends State<HutangPage> {
  ...
  getHutang() async {
    try {
      _listHutang.clear();
      final response =
          await http.get(NetworkURL.hutang(), headers: <String, String>{
      ...
      if (responJson["success"] == true) {
        ...
        setState(() {
          ...
          for (Map i in data) {
            _listHutang
                .add([i["id"], i["description"], i["value"], i["debt_date"]]);
          }
        });
      } else {
        setState(() {
                          ...
                          return Column(
                            children: <Widget>[
                              ListTile(
                                ...
                                title: Text(_listHutang[index][1].toString(),
                                    style: TextStyle(
