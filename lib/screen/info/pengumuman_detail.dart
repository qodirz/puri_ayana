...
class PengumumanItem extends StatefulWidget {
  ...
  PengumumanItem(
      this.pengumumanID, this.title, this.description, this.isRead, this.date);
    ...
    return TextButton(
      ...
      onPressed: () {
        _settingModalBottomSheet(
            context, widget.title, widget.description, widget.date);
        setState(() {
          widget.isRead = true;
        });
      ...
      child: ListTile(
        ...
        trailing: Icon(Icons.notification_important,
            size: 26, color: widget.isRead == true ? Colors.grey : baseColor),
        tileColor: widget.isRead == true ? baseColor50 : baseColor100,
        title: Text(
          widget.title,
